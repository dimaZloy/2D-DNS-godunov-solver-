...
@everywhere function nodesGradientReconstructionFastPerThread22UCons(beginCell::Int32, endCell::Int32, testMesh::mesh2d_Int32, 
...
# @everywhere function nodesGradientReconstructionUconsFastSA33(beginCell::Int32, endCell::Int32, testMesh::mesh2d_Int32, 
  # ucons::Array{Float64,2}, viscousFields2dX::viscousFields2d)
  ...
  # for V = 2:4
	  ...
	  # for C =  beginCell:endCell
			  ...
			  # if (testMesh.cells2nodes[C,1] > 0) 	
				# phiLeft[1] =  ucons[ testMesh.cells2nodes[C,1] ,V ];
			  # elseif (testMesh.cells2nodes[C,2] > 0) 	
				# phiRight[1] = ucons[ testMesh.cells2nodes[C,2] ,V ];
			  # elseif (testMesh.cells2nodes[C,3] > 0) 	
				# phiLeft[2] =  ucons[ testMesh.cells2nodes[C,3] ,V ];
			  # elseif (testMesh.cells2nodes[C,4] > 0) 		
				# phiRight[2] = ucons[ testMesh.cells2nodes[C,4] ,V ];
			  # elseif (testMesh.cells2nodes[C,5] > 0) 		
				# phiLeft[3] =  ucons[ testMesh.cells2nodes[C,5] ,V ];
			  # elseif (testMesh.cells2nodes[C,6] > 0) 		
				# phiRight[3] = ucons[ testMesh.cells2nodes[C,6] ,V ];
			  # end
			  
			  # if (testMesh.mesh_connectivity[C,3] == 4)
			  
				# if (testMesh.cells2nodes[C,7] > 0) 	
					# phiLeft[4] =  ucons[ testMesh.cells2nodes[C,7] ,V ];
				# elseif (testMesh.cells2nodes[C,8] > 0) 		
					# phiRight[4] = ucons[ testMesh.cells2nodes[C,8] ,V ];
				# end	
